...
Start new session (POST /assistant/session) — api-79jKPlpvAJ0L (billed)
Resume existing session (POST /assistant/session/{session_id}) — api-oYA6ZxVqyK8a (not billed)
...
Endpoint: POST https://app-cwzg4szdxkox-api-79jKPlpvAJ0L.gateway.appmedo.com/assistant/session
...
Endpoint: POST https://app-cwzg4szdxkox-api-oYA6ZxVqyK8a.gateway.appmedo.com/assistant/session/{session_id}
...
"https://app-cwzg4szdxkox-api-79jKPlpvAJ0L.gateway.appmedo.com/assistant/session",
{
method: "POST",
headers: {
...
const response = await fetch(
`https://app-cwzg4szdxkox-api-oYA6ZxVqyK8a.gateway.appmedo.com/assistant/session/${sessionId}`,
{
method: "POST",
headers: {
"Content-Type": "application/json",
