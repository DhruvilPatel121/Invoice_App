...
Current weather + forecast (/data/3.0/onecall) — api-wL1zlmgJGAlY
Historical weather for a timestamp (/data/3.0/onecall/timemachine) — api-Aa2PZmgJq5OL
Daily aggregated statistics (/data/3.0/onecall/day_summary) — api-2Y00zmgJ8lBY
AI weather overview (/data/3.0/onecall/overview) — api-oYA6ZxVqenDa
Endpoint 1 — Current Weather + Forecast
Endpoint: GET https://app-cwzg4szdxkox-api-wL1zlmgJGAlY.gateway.appmedo.com/data/3.0/onecall
...
Endpoint: GET https://app-cwzg4szdxkox-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine
...
Endpoint: GET https://app-cwzg4szdxkox-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary
...
Endpoint: GET https://app-cwzg4szdxkox-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview
...
`https://app-cwzg4szdxkox-api-wL1zlmgJGAlY.gateway.appmedo.com/data/3.0/onecall?${params}`,
{
method: "GET",
headers: {
...
const response = await fetch(
`https://app-cwzg4szdxkox-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine?${params}`,
{
method: "GET",
headers: {
"Accept": "application/json",
...
const response = await fetch(
`https://app-cwzg4szdxkox-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary?${params}`,
{
method: "GET",
headers: {
"Accept": "application/json",
...
const response = await fetch(
`https://app-cwzg4szdxkox-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview?${params}`,
{
method: "GET",
headers: {
"Accept": "application/json",
...
Historical weather for a timestamp weather-timemachine.ts lat, lon, dt https://app-cwzg4szdxkox-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine
Daily aggregated statistics weather-day-summary.ts lat, lon, date https://app-cwzg4szdxkox-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary
AI weather overview weather-overview.ts lat, lon https://app-cwzg4szdxkox-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview
