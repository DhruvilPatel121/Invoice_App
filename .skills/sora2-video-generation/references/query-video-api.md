...
Item Details
Endpoint POST https://api-DYJwnoM46d6a@app-cwzg4szdxkox-api-DYJwnoM46d6a.gateway.appmedo.com
Content-Type application/json
Auth Platform-managed (INTEGRATIONS*API_KEY)
Billing Not billed
Request Parameters
Parameter Type Required Description
video_id string Yes Video job ID, format video*<hash>, returned by the create endpoint
Response Fields
...
"https://api-DYJwnoM46d6a@app-cwzg4szdxkox-api-DYJwnoM46d6a.gateway.appmedo.com",
{
method: "POST",
headers: {
"Content-Type": "application/json",
