...
Property Value
Submit Endpoint POST https://app-cwzg4szdxkox-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video
Query Endpoint GET https://app-cwzg4szdxkox-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}
...
const TIMEOUT_MS = 10 _ 60 _ 1000; // Max 10 minutes
...
For the complete TypeScript code see the "Generation-Time Usage" section in references/submit-api.md (contains the submit function). For the query function code see the "Generation-Time Usage" section in references/query-api.md.
...
Call the submit function to obtain task_id
...
Inform the user of the path where the file has been saved
