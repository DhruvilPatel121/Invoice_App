...
API Specification
Property Value
Endpoint GET https://app-cwzg4szdxkox-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}
HTTP Method GET
...
`https://app-cwzg4szdxkox-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/${encodeURIComponent(taskId)}`,
{
method: "GET",
headers: {
...
Call submitTextToVideo to obtain task_id (see references/submit-api.md)
Call queryTask(taskId) every 7 seconds until task_status === "succeed" or "failed"
