...
Property Value
Endpoint GET https://app-cwzg4szdxkox-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl
...
`https://app-cwzg4szdxkox-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl?${params.toString()}`,
{
method: "GET",
headers: {
