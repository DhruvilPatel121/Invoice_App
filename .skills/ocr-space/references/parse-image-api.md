...
Property Value
Endpoint POST https://app-cwzg4szdxkox-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image
...
const response = await fetch("https://app-cwzg4szdxkox-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
method: "POST",
headers: {
...
// --- Call upstream ---
const upstream = await fetch("https://app-cwzg4szdxkox-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
method: "POST",
headers: {
