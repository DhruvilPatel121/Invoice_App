...
POST https://app-cwzg4szdxkox-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image POST Core OCR endpoint supporting URL / file upload / Base64 input methods, with advanced features such as table recognition and coordinate overlay Enabled (per-call billing)
GET https://app-cwzg4szdxkox-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl GET Simplified GET endpoint supporting URL-only image submission, suitable for quick integration Not billed
