...
license:MIT
The News
Provide global news from thousands of sources with exceptional response times. This skill wraps the The News API and exposes five endpoints covering top stories, full article search, similar article discovery, single-article lookup, and source listing.

Capability Overview
Endpoint Method URL
Top Stories GET https://app-cwzg4szdxkox-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top
All News GET https://app-cwzg4szdxkox-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all
Similar News GET https://app-cwzg4szdxkox-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}
News by UUID GET https://app-cwzg4szdxkox-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}
Sources GET https://app-cwzg4szdxkox-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources
Base host: app-cwzg4szdxkox-api-wL1zlEdVM6DY.gateway.appmedo.com
...
Top Stories — fetching trending/top news globally or by country → GET /v1/news/top
All News — searching the complete article database with filters → GET /v1/news/all
Similar News — finding articles related to a known article UUID → GET /v1/news/similar/{uuid}
News by UUID — fetching a single article by its UUID → GET /v1/news/uuid/{uuid}
Sources — discovering source IDs/domains for use in filtering → GET /v1/news/sources
For full parameter tables and code samples, read the relevant reference file:

Read references/top-stories-api.md for Top Stories spec and code. Read references/all-news-api.md for All News spec and code. Read references/similar-news-api.md for Similar News spec and code. Read references/news-by-uuid-api.md for News by UUID spec and code. Read references/sources-api.md for Sources spec and code.
