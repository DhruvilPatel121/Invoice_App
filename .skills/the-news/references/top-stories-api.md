Top Stories API
Endpoint: GET https://app-cwzg4szdxkox-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top
...
`https://app-cwzg4szdxkox-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top${qs ? `?${qs}` : ""}`,
{
method: "GET",
headers: {
