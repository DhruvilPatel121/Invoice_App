Similar News API
Endpoint: GET https://app-cwzg4szdxkox-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}
...
`https://app-cwzg4szdxkox-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/${encodeURIComponent(uuid)}${qs ? `?${qs}` : ""}`,
{
method: "GET",
headers: {
