News by UUID API
Endpoint: GET https://app-cwzg4szdxkox-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}
...
`https://app-cwzg4szdxkox-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/${encodeURIComponent(uuid)}`,
{
method: "GET",
headers: {
