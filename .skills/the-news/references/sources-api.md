Sources API
Endpoint: GET https://app-cwzg4szdxkox-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources
...
`https://app-cwzg4szdxkox-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources${qs ? `?${qs}` : ""}`,
{
method: "GET",
headers: {
