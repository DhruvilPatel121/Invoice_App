All News API
Endpoint: GET https://app-cwzg4szdxkox-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all
...
`https://app-cwzg4szdxkox-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all${qs ? `?${qs}` : ""}`,
{
method: "GET",
headers: {
