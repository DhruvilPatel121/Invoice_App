...
API ID: api-rLobRWZ712b9 Plugin: Image Generation (Lite Version) · a02d2a73-a173-4f8c-8565-c8df8fa929a1

Capability Overview
Item Value
Method POST
Endpoint https://app-cwzg4szdxkox-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent
...
"https://app-cwzg4szdxkox-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent",
{
method: "POST",
headers: {
"Content-Type": "application/json",
...
Call generateOrEditImage(instruction, sourceImageBase64?, mimeType?) to obtain imageBase64
Use the Bash tool to decode and save the Base64 data: echo "<imageBase64>" | base64 -d > <local_path>.png
