...
Ask user for preferences (colors, mood, audience)
Generate theme with name, colors, fonts
Show for review
Apply to artifact
Application Process
Identify need - User wants styling
Choose approach - Theme / Brand / Custom
Apply styling - Colors, fonts, layout
Verify - Ensure readability and consistency
Key Principles
