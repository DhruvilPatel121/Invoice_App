...
Field Value
Method POST
URL https://app-cwzg4szdxkox-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task
...
"https://app-cwzg4szdxkox-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task",
{
method: "POST",
headers: {
"Content-Type": "application/json",
...
/\*_ Decode Base64 embedded in the Markdown image string and upload to Supabase Storage. _/
