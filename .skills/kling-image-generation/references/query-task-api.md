...
Overview
Item Details
Endpoint GET https://app-cwzg4szdxkox-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}
...
for i in 0 1 2; do
curl -L -o "./generated*image*${i}.jpg" "<task_result.images[$i].url>"
done
