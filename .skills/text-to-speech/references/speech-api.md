...
API Specification
Property Value
Endpoint POST https://app-cwzg4szdxkox-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech
HTTP Method POST
...
const response = await fetch("https://app-cwzg4szdxkox-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
method: "POST",
headers: {
...
curl -s -X POST "https://app-cwzg4szdxkox-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech" \
...
Make the request using the curl command above (or the TypeScript function)
Use the Bash tool to run curl ... -o <local-path>.mp3 to save the audio locally
Inform the user that the file has been saved to the specified path and explain how to play it
...
// --- Call upstream ---
const upstream = await fetch("https://app-cwzg4szdxkox-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
method: "POST",
headers: {
"Content-Type": "application/json",
"X-Gateway-Authorization": `Bearer ${apiKey}`,
