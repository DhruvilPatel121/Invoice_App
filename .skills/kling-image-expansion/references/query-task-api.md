...
Capability Overview
Item Details
Endpoint GET https://app-cwzg4szdxkox-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}
...
Capability Overview
Item Details
Endpoint GET https://app-cwzg4szdxkox-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand
...
const url = new URL(
"https://app-cwzg4szdxkox-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand"
);
...
`https://app-cwzg4szdxkox-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/${task_id}`,
{
method: "GET",
headers: {
"Content-Type": "application/json",
