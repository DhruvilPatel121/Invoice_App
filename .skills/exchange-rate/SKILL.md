...
Property Value
Endpoint GET https://app-cwzg4szdxkox-api-w9Rbo8E7p2b9.gateway.appmedo.com/v6/latest/{base_currency}
...
const url = `https://app-cwzg4szdxkox-api-w9Rbo8E7p2b9.gateway.appmedo.com/v6/latest/${baseCurrency.toUpperCase()}`;
...
`https://app-cwzg4szdxkox-api-w9Rbo8E7p2b9.gateway.appmedo.com/v6/latest/${baseCurrency.toUpperCase()}`,
{
method: "GET",
headers: {
"Accept": "application/json",
