...
API Overview
Item Details
Endpoint GET https://app-cwzg4szdxkox-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/{id}
...
`https://app-cwzg4szdxkox-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/${encodeURIComponent(taskId)}`,
{
method: "GET",
headers: {
"Content-Type": "application/json",
...
Call submitImageToVideo() to obtain task_id (see submit-api.md)
Call queryImageToVideoTask(taskId) every 7 seconds to poll status
When task_status === "succeed", retrieve task_result.videos[0].url
Use the Bash tool to run curl -L -o ./output_video.mp4 "<url>" to download the video locally
