...
API Specification
Property Value
Endpoint GET https://app-cwzg4szdxkox-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}
HTTP Method GET
...
`https://app-cwzg4szdxkox-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/${encodeURIComponent(taskId)}`,
{
method: "GET",
headers: {
...
Call submitOmniVideo(options) to obtain task_id (see references/submit-api.md)
Call queryOmniVideoTask(taskId) every 7 seconds until task_status === "succeed" or "failed"
