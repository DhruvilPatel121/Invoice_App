...
Property Value
Submit Endpoint POST https://app-cwzg4szdxkox-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video
Query Endpoint GET https://app-cwzg4szdxkox-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}
...
const TIMEOUT_MS = 10 _ 60 _ 1000; // maximum 10 minutes
...
For the full TypeScript submit function, see the "Generation-time Usage" section in references/submit-api.md. For the query function, see the "Generation-time Usage" section in references/query-api.md.
...
Call the submit function to obtain task_id (see references/submit-api.md)
Call the query function every 7 seconds until task_status === "succeed"
Retrieve the video URL from task_result.videos[0].url
